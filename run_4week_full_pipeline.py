...
def run_instance(instance_id: str, weeks: list, history: int) -> list:
...
def _print_report(instance_id: str, rows: list) -> None:
    print(f"\n{'='*80}")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--weeks", type=int, nargs="+", default=[0, 1, 2, 3])
    ...
    rows = run_instance(args.instance, args.weeks, args.history)
    _print_report(args.instance, rows)
